...
const pages = [
    ...
    { loc: '/about', priority: '0.7', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/about' }, { lang: 'ar-AE', href: '/about-ar' }] },
    { loc: '/about-ar', priority: '0.7', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/about-ar' }, { lang: 'en', href: '/about' }] },
    { loc: '/llms.txt', priority: '0.3', changefreq: 'monthly' },
    { loc: '/guides/', priority: '0.8', changefreq: 'weekly' },
        { loc: '/guides/compress-image-to-200kb', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/compress-image-to-200kb' }, { lang: 'ar-AE', href: '/guides/compress-image-to-200kb-ar' }] },
    { loc: '/guides/compress-image-to-200kb-ar', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/compress-image-to-200kb-ar' }, { lang: 'en', href: '/guides/compress-image-to-200kb' }] },
    { loc: '/guides/compress-image-to-500kb', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/compress-image-to-500kb' }, { lang: 'ar-AE', href: '/guides/compress-image-to-500kb-ar' }] },
    { loc: '/guides/compress-image-to-500kb-ar', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/compress-image-to-500kb-ar' }, { lang: 'en', href: '/guides/compress-image-to-500kb' }] },
    { loc: '/guides/emirates-id-photo-size', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/emirates-id-photo-size' }, { lang: 'ar-AE', href: '/guides/emirates-id-photo-size-ar' }] },
    { loc: '/guides/emirates-id-photo-size-ar', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/emirates-id-photo-size-ar' }, { lang: 'en', href: '/guides/emirates-id-photo-size' }] },
    { loc: '/guides/ica-photo-upload-requirements', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/ica-photo-upload-requirements' }, { lang: 'ar-AE', href: '/guides/ica-photo-upload-requirements-ar' }] },
    { loc: '/guides/ica-photo-upload-requirements-ar', priority: '0.9', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/ica-photo-upload-requirements-ar' }, { lang: 'en', href: '/guides/ica-photo-upload-requirements' }] },
