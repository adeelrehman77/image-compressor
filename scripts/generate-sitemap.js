...
const pages = [
    ...
    { loc: '/#ai-upscaler', priority: '0.85', changefreq: 'monthly' },
    { loc: '/#remove-bg', priority: '0.85', changefreq: 'monthly' },
    { loc: '/#collage-maker', priority: '0.8', changefreq: 'monthly' },
    ...
    { loc: '/guides/nexuscompress-image-compressor-faq.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/nexuscompress-image-compressor-faq.html' }, { lang: 'ar-AE', href: '/guides/nexuscompress-image-compressor-faq-ar.html' }] },
    { loc: '/guides/nexuscompress-image-compressor-faq-ar.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/nexuscompress-image-compressor-faq-ar.html' }, { lang: 'en', href: '/guides/nexuscompress-image-compressor-faq.html' }] },
    { loc: '/guides/uae-photo-compliance-checker.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/uae-photo-compliance-checker.html' }, { lang: 'ar-AE', href: '/guides/uae-photo-compliance-checker-ar.html' }] },
    { loc: '/guides/uae-photo-compliance-checker-ar.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/uae-photo-compliance-checker-ar.html' }, { lang: 'en', href: '/guides/uae-photo-compliance-checker.html' }] },
    { loc: '/guides/redact-emirates-id-documents.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/redact-emirates-id-documents.html' }, { lang: 'ar-AE', href: '/guides/redact-emirates-id-documents-ar.html' }] },
    { loc: '/guides/redact-emirates-id-documents-ar.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/redact-emirates-id-documents-ar.html' }, { lang: 'en', href: '/guides/redact-emirates-id-documents.html' }] },
    { loc: '/guides/ai-image-upscaler-browser.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'en', href: '/guides/ai-image-upscaler-browser.html' }, { lang: 'ar-AE', href: '/guides/ai-image-upscaler-browser-ar.html' }] },
    { loc: '/guides/ai-image-upscaler-browser-ar.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/ai-image-upscaler-browser-ar.html' }, { lang: 'en', href: '/guides/ai-image-upscaler-browser.html' }] },
