...
const pages = [
    ...
    { loc: '/guides/uae-portal-compression-ar.html', priority: '0.85', changefreq: 'monthly', alternates: [{ lang: 'ar-AE', href: '/guides/uae-portal-compression-ar.html' }, { lang: 'en', href: '/' }] },
